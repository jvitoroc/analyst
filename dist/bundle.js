...
*/
var aa=__webpack_require__(1),m=__webpack_require__(14),A=__webpack_require__(6),B=__webpack_require__(3),ca=__webpack_require__(15),da=__webpack_require__(16),ea=__webpack_require__(17),ha=__webpack_require__(18),ia=__webpack_require__(19),C=__webpack_require__(9);
...
var _RepositorySearch = __webpack_require__(40);

var _RepositorySearch2 = _interopRequireDefault(_RepositorySearch);
...
function App() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(_RepositorySearch2.default, { maxReposLength: 10 })
    );
}
...
var _getData = __webpack_require__(59);
...
var RepositorySearch = function (_React$Component) {
    _inherits(RepositorySearch, _React$Component);
    ...
    _createClass(RepositorySearch, [{
        key: "pullData",
        value: async function pullData(query) {
            try {
                this.setState({ loading: true, error: false, mounted: false });
                var data = await (0, _getData2.default)(query, this.props.maxReposLength);
                this.setState({ loading: false, data: data, mounted: false });
            } catch (rejected) {
        ...
        value: function render() {
            return _react2.default.createElement(_View2.default, _extends({ pullData: this.pullData }, this.state));
        }
    }]);
...
var _RepositoryList = __webpack_require__(55);
...
function View(props) {
    var render = function render() {
        if (props.mounted) return _react2.default.createElement(_Message2.default, { value: "Pick a repository!" });else if (props.error) return _react2.default.createElement(_Message2.default, { value: "An error occurred!" });else if (props.data.length !== 0) return _react2.default.createElement(_RepositoryList2.default, { repos: props.data });else return _react2.default.createElement(_Message2.default, { value: "No repositories found!" });
    };

    return _react2.default.createElement(
        "div",
        { className: "main" },
        _react2.default.createElement(_SearchInput2.default, { onSearch: props.pullData }),
        _react2.default.createElement(
            "div",
            { className: "container" },
            props.loading ? null : render(),
            _react2.default.createElement(_Loading2.default, { state: (0, _classnames2.default)({ hidden: !props.loading }) })
        )
    );
};
...
View.propTypes = {
    ...
    pullData: _propTypes2.default.func.isRequired
};
...
var _extractValue = __webpack_require__(45);

var _extractValue2 = _interopRequireDefault(_extractValue);
...
var SearchInput = function (_React$Component) {
    ...
    _createClass(SearchInput, [{
        ...
        value: function handleChange(e) {
            this.setState({ value: (0, _extractValue2.default)(e.target.value) });
        }
    }, {
        key: "render",
        value: function render() {
            return _react2.default.createElement(
                "form",
                { onSubmit: this.onSubmit, className: "search-input" },
                _react2.default.createElement(
                    "div",
                    { className: "container" },
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement("input", { onChange: this.handleChange, className: "form-control", type: "text", name: "query" })
                        ),
                        _react2.default.createElement(
                            "div",
                            { className: "col-4 col-sm-2" },
                            _react2.default.createElement("input", { type: "submit", value: "Search", className: "btn btn-primary form-control" })
                        )
                    )
                )
            );
...
function extractValue(data) {
    var regex = new RegExp("^((https?://)?(www.)?github.com/)?(.*)");
...
function Loading(props) {
    var className = {};
    className[_Loading2.default.hidden] = props.state;
...
function RepositoryList(props) {
    var renderRepos = function renderRepos() {
        ...
        return props.repos.map(function (e, i) {
            return _react2.default.createElement(_Repository2.default, _extends({}, e, { key: i }));
        });
    };
    return _react2.default.createElement(
        'ul',
...
function Repository(props) {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                "div",
                { className: "avatar col-12 col-sm-2 d-flex align-items-center" },
                _react2.default.createElement("img", { className: "img-fluid", src: props.avatarUrl, alt: props.name })
            ),
            _react2.default.createElement(
                "div",
                { className: "desc col-12 col-sm-10" },
                _react2.default.createElement(
                    "h3",
                    { className: "title" },
                    props.name
...
Repository.propTypes = {
    ...
    starsCount: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number]),
    issuesCount: _propTypes2.default.oneOfType([_propTypes2.default.string, _propTypes2.default.number])
};
...
if(false) {
	// When the styles change, update the <style> tags
	if(!content.locals) {
		module.hot.accept("!!../../../node_modules/css-loader/index.js!./RepositoryList.css", function() {
			var newContent = require("!!../../../node_modules/css-loader/index.js!./RepositoryList.css");
			if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
			update(newContent);
		});
	}
...
// module
exports.push([module.i, ".main .repository-list{\r\n    list-style-type: none;\r\n    padding: 40px 0;\r\n}\r\n\r\n.main .message-wrap{\r\n    margin-top: 100px;\r\n}\r\n\r\n.main .message-wrap h3{\r\n    text-align: center;\r\n}\r\n\r\n.main .repository-list > .repository{\r\n    border-radius: 20px;\r\n    padding: 15px;\r\n    margin-bottom: 10px;\r\n    cursor: pointer;\r\n    border: 1px rgba(0, 0, 0, 0.2) solid;\r\n}\r\n\r\n.main .repository-list > .repository .avatar > img{\r\n    max-width: 80px;\r\n    min-width: 60px;\r\n}\r\n\r\n.main .repository-list > .repository .desc{\r\n    word-break: break-all;\r\n}\r\n\r\n@media screen and (max-width: 575px){\r\n    .main .repository-list > .repository .avatar > img{\r\n        padding: 10px;\r\n        display: block;\r\n        margin: 0 auto;\r\n    }\r\n\r\n    .main .repository-list > .repository .desc{\r\n        text-align: center;\r\n    }\r\n\r\n    .main .repository-list > .repository .desc .title{\r\n        font-size: 1.5em;\r\n    }\r\n}\r\n", ""]);
...
function getRepositories(query, amount) {
    var url = "https://api.github.com/search/repositories?" + ("q=" + query + "&") + ("per_page=" + amount + "&") + "client_id=085153c53d393d9f0d9c";

    return _axios2.default.get(url).then(checkStatus).then(extractRequired);
}
...
// module
exports.push([module.i, "body{\r\n    overflow-x: hidden;\r\n}\r\n\r\n/*.analyzed-data{\r\n    margin-top: 40px;\r\n}\r\n\r\n.most-used-words .word-list{\r\n    list-style-type: decimal;\r\n}\r\n\r\n.most-used-words .word{\r\n    font-size: 1.5em;\r\n}\r\n\r\n.analyze-column-inner{\r\n    border: 1px rgba(0, 0, 0, 0.2) solid;\r\n    padding: 15px;\r\n    border-radius: 20px;\r\n}*/\r\n\r\n.hightlight{\r\n    font-weight: bold;\r\n}\r\n", ""]);

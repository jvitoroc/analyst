...
*/
var aa=__webpack_require__(2),m=__webpack_require__(12),A=__webpack_require__(4),B=__webpack_require__(3),ca=__webpack_require__(13),da=__webpack_require__(14),ea=__webpack_require__(15),ha=__webpack_require__(16),ia=__webpack_require__(17),C=__webpack_require__(5);
...
// module
exports.push([module.i, "body{\n    overflow-x: hidden;\n}\n\n.header{\n    background: #0277BD;\n    color: #fff;\n    padding: 100px 0 50px 0;\n}\n\n.search-box{\n    margin-top: 20px;\n}\n\n.repos .repository-list{\n    list-style-type: none;\n    padding: 40px 0;\n}\n\n.message-wrap{\n    margin-top: 100px;\n}\n\n.message-wrap h3{\n    text-align: center;\n}\n\n.repos .repository-list > .repository{\n    border-radius: 20px;\n    padding: 15px;\n    margin-bottom: 10px;\n    cursor: pointer;\n    border: 1px rgba(0, 0, 0, 0.2) solid;\n}\n\n.repos .repository-list > .repository .avatar > img{\n    max-width: 80px;\n    min-width: 60px;\n}\n\n.repos .repository-list > .repository .desc{\n    word-break: break-all;\n}\n\n.hightlight{\n    font-weight: bold;\n}\n\n@media screen and (max-width: 575px){\n    .repos .repository-list > .repository .avatar > img{\n        padding: 10px;\n        display: block;\n        margin: 0 auto;\n    }\n\n    .repos .repository-list > .repository .desc{\n        text-align: center;\n    }\n\n    .repos .repository-list > .repository .desc .title{\n        font-size: 1.5em;\n    }\n}\n", ""]);
...
var _RepositoryList = __webpack_require__(62);
...
var _extractValue = __webpack_require__(71);
...
var Main = function (_React$Component) {
    ...
    function Main(props) {
        ...
        _this.state = { repos: null, value: '', gettingRepos: false, justMounted: true };

        _this.handleChange = _this.handleChange.bind(_this);
        _this.getRepositories = _this.getRepositories.bind(_this);
        return _this;
    }

    _createClass(Main, [{
        key: 'getRepositories',
        value: function getRepositories(e) {
            var _this2 = this;

            //Get 10 repositories from GitHub
            this.setState({ gettingRepos: true, justMounted: false });
            var that = this;
            setTimeout(function () {
                _axios2.default.get('https://api.github.com/search/repositories?q=' + _this2.state.value + '&per_page=3&client_id=085153c53d393d9f0d9c').then(function (response) {
                    if (response.data.total_count && response.data.total_count !== 0) that.repositoriesReceived(response.data);else that.repositoriesReceived(false);
                }).catch(function (error) {
        ...
        key: 'repositoriesReceived',
        value: function repositoriesReceived(data) {
            this.setState({ repos: data, gettingRepos: false });
        }
    }, {
        key: 'branchRender',
        value: function branchRender() {
            if (this.state.gettingRepos) {
                return _Message2.default.LoadingComponent;
            } else {
                if (this.state.repos === 'error' || this.state.repos === false || this.state.repos == null) {
                    return _Message2.default.NotFoundComponent;
                } else {
                    return _react2.default.createElement(_RepositoryList2.default, { repos: this.state.repos.items });
                }
            }
        }
    }, {
        ...
        value: function handleChange(e) {
            //Get the value (name of repository) from the input-text
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                this.state.justMounted ? _Message2.default.StartingComponent : this.branchRender()
            );
        }
    }]);
...
var _Repository = __webpack_require__(63);
...
var RepositoryList = function (_React$Component) {
    ...
    _createClass(RepositoryList, [{
        ...
        value: function renderRepos() {
            //Whenever this component is updated this function is called in the render function
            return this.props.repos.map(function (e, i) {
        ...
        value: function render() {
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    'ul',
                    { className: 'repository-list clearfix' },
                    this.renderRepos()
                )
            );
        }
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement("img", { className: "img-fluid", src: props.avatar_url, alt: props.full_name })
            ),
            _react2.default.createElement(
                "div",
...
function SearchBox(props) {
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      "form",
      { onSubmit: props.getRepositories },
      _react2.default.createElement(
        "div",
        { className: "form-row" },
        _react2.default.createElement(
          ...
          _react2.default.createElement("input", { type: "text", onChange: props.handleChange, className: "form-control", placeholder: "Repository name" })
        ),
        _react2.default.createElement(
          "button",
          { type: "submit", className: "btn btn-primary col-3 col-sm-2" },
          "Search"
        )
      )
    )
...
var _Starting = __webpack_require__(66);
...
var Messages = {
    StartingComponent: _react2.default.createElement(_Starting2.default, null),
    NotFoundComponent: _react2.default.createElement(_NotFound2.default, null),
    LoadingComponent: _react2.default.createElement(_Loading2.default, null)
};
